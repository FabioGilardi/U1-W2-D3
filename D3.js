...
for (let i = 0; i < starWarsCharacters.length; i++) {
  letNames = starWarsCharacters[i].name;
  charactersNames.push(letNames);
}
...
console.log("l'oggetto è vuoto", eyeColor);
...
for (let i = 0; i < starWarsCharacters.length; i++) {
  switch (starWarsCharacters[i].eye_color) {
    ...
    case "red":
      ...
      break;
    case "blue-gray":
      eyeColor.bluGray.push(starWarsCharacters[i].name);
      break;
    default:
  }
}

console.log("l'oggetto è stato correttamente popolato", eyeColor);
...
// Ho fatto una prova con il for per vedere se fosse giusto
// for (let i = 0; i < starWarsCharacters.length; i++) {
...
console.log("Personaggi a cui è stato applicato il cambio da n/a a robot:");
for (let i = 0; i < starWarsCharacters.length; i++) {
...
console.log(
  "la lunghezza dell'array characterNames è di:",
...
console.log(
  "la lunghezza dell'array characterNames è diventata:",
  charactersNames.length
);
...
let casual = Math.floor(Math.random() * 10);

console.log(
  "Mi chiamo",
  starWarsCharacters[casual].name,
  "e sono",
  starWarsCharacters[casual].gender,
  ". Sono alto",
  starWarsCharacters[casual].height,
  "cm e peso",
  starWarsCharacters[casual].mass,
  "kg. Ho i capelli color",
  starWarsCharacters[casual].hair_color,
  "e la mia pelle è",
  starWarsCharacters[casual].skin_color,
  "mentre i miei occhi sono",
  starWarsCharacters[casual].eye_color,
  ". Sono nato nel",
  starWarsCharacters[casual].birth_year
);
